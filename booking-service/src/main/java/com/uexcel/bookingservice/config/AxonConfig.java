package com.uexcel.bookingservice.config;
...
public class AxonConfig {
    ...
    public XStream xStream() {
        ...
        xStream.allowTypesByWildcard(new String[]{
                ...
                "com.uexcel.bookingservice.command.*",
                "com.uexcel.bookingservice.query.*",
                "com.uexcel.bookingservice.command.controller.*",
                "com.uexcel.bookingservice.saga.BookingSaga",
                "java.util.*", "java.lang.*"
        });
        return xStream;
    }
